...
class FoodCourseModel: NSObject {
    ...
    class func parseModelWithData(data:NSData)->FoodCourseModel{
        ...
        model.data = FoodCourseDataModel.praseModel(subJSON)
        return model
    }
}
...
class FoodCourseDataModel:NSObject{
    ...
    class func praseModel(jsonData:JSON)->FoodCourseDataModel{
        ...
        var dataArray = Array<FoodCourseSerialModel>()
        for (_,subJOSN) in array{
            let dataModel = FoodCourseSerialModel.praseModel(subJOSN)
...
class FoodCourseSerialModel:NSObject{
    ...
    class func praseModel(jsonData:JSON)->FoodCourseSerialModel{
